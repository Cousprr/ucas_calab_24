...
module ID(
    ...
    output wire [351:0] ID_to_EXE_bus,
    //from WB
...
//exp13 add start
    ...
    assign inst_all = inst_add_w | inst_sub_w | inst_slt | inst_sltu | 
                       ...
                       inst_invtlb | inst_tlbrd | inst_tlbwr | inst_tlbfill | inst_tlbsrch;//todo:exp19 add expcetion op>0x6
    ...
    assign  ID_exc_type[`TYPE_INE] = ~(ID_exc_type[`TYPE_ADEF]) & (~inst_all | (inst_invtlb & invtlb_op > 5'b00110));//������ȡ��ַ����ǰ���£�����Ŀǰ��ʵ�ֵ�����һ��ָ��
...
//to EXE and IF
    assign ID_to_EXE_bus = {id_refetch, inst_tlbsrch, inst_tlbrd, inst_tlbwr, inst_tlbfill, inst_invtlb, invtlb_op, rj_value,//exp18 add 44bit
